...
shareLink.addEventListener("click", function (e) {
    e.preventDefault();
    const url = "https://proyolo-ks1.github.io/autobahn-sign-generator/";

    if (navigator.share) {
        navigator.share({
            title: "Autobahn Sign Generator",
            text: "Generate your custom Autobahn Sign! with live formatting!",
            url: url
        }).catch(err => {
...
document.querySelectorAll('.color-btn').forEach(btn => {
    ...
    btn.addEventListener('mouseenter', () => {
        ...
        tooltip.style.backgroundColor = 'var(--color-button-tooltip-background)';
